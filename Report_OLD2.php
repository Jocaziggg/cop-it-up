...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
 ...
 <!-- <nav>
    ...
    <a href ="calculator3.php" target="_blank"><button id="New_calc" class="btn_NEXT1" name="btn_REPORT">New calculation</button></a>   <a href ="https://www.cop-it-up.com/" target="_blank"><button id="Blog" class="btn_NEXT1" name="btn_REPORT">Blog</button></a></div>
...
<!--<section class="section3">-->
            <div class="sc_page1R">
              <div id="report_pdf4">
                     ...
                     <div class="sc_page1_desc">In this report you can find heat loss details for every room. In 'Overall' section you will find the capacity of a heat pump that you need for your property. You can also download pdf and use it to make the best deal. Thank you.</div>
	    ...
	    <tr>
	      ...
	      <td ><?php $R_TL_W = $Rrow['T_Loss_Wall']; echo $R_TL_W; ?></td>

	      <td ><?php $RF_Case = $Rrow['Floor_Case'];
	      ...
	      <td ><?php $RC_Case = $Rrow['Ceiling_Case'];
	      ...
	      <td ><?php $R_TL_D1 = $Rrow['T_Loss_Window']; 
                              $R_TL_D2 = $Rrow['T_Loss_Door'];
                              $R_TL_D = $R_TL_D1 + $R_TL_D2;
                              echo $R_TL_D; ?></td>
        <td ><?php $N_Vent = $Rrow['N_Vent'];
                              $M_Vent = $Rrow['M_Vent'];
        ...
        ?></td>
	      ...
	      <td  style="font-weight:bold"><?php if($Vent_Case == 'Nat'){$R_TL_T = $Rrow['THL_NVent'];}else{$R_TL_T = $Rrow['THL_MVent'];} echo $R_TL_T; ?></td>
...
<table class="report_table1">
    ...
    <tr>
      <td style="font-weight:bold"><?php echo "Sum for property" ?></td>
      <td colspan="6">Termal loss (W)</td>
    </tr>
    ...
    <tr>
      ...
      <td style="font-weight:bold"><?php if($Vent_Case = 'Nat'){$R_TL_TS = $TS_WNT;}else{$R_TL_TS = $TS_WMT;} echo (round($R_TL_TS,2)); ?></td>
